...
import ut.math.MutableBigInteger;
...
class SignedMutableBigInteger extends ut.math.MutableBigInteger {
   ...
   /**
     ...
     */
    SignedMutableBigInteger(ut.math.MutableBigInteger val) {
        super(val);
    }
   ...
   /**
     * Signed addition built upon unsigned add and subtract.
     */
    void signedAdd(ut.math.MutableBigInteger addend) {
        if (sign == 1)
            add(addend);
        else
            sign = sign * subtract(addend);
   ...
   /**
     * Signed subtraction built upon unsigned add and subtract.
     */
    void signedSubtract(ut.math.MutableBigInteger addend) {
        if (sign == 1)
            sign = sign * subtract(addend);
        else
            add(addend);
