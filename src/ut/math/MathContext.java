 ...
 * implemented by the {@link java.math.BigDecimal} class.
 *
 ...
 * a {@link ut.math.RoundingMode} object which specifies the algorithm to be
 * used for rounding.
 * </ol>
 *
 * @see     BigDecimal
 * @see     ut.math.RoundingMode
...
public final class MathContext implements Serializable {
    ...
    private static final ut.math.RoundingMode DEFAULT_ROUNDINGMODE = ut.math.RoundingMode.HALF_UP;
    ...
    public static final MathContext UNLIMITED =
        new MathContext(0, ut.math.RoundingMode.HALF_UP);

    /**
     *  A {@code MathContext} object with a precision setting
     *  matching the IEEE 754R Decimal32 format, 7 digits, and a
     *  rounding mode of {@link ut.math.RoundingMode#HALF_EVEN HALF_EVEN}, the
     *  IEEE 754R default.
     */
    public static final MathContext DECIMAL32 =
        new MathContext(7, ut.math.RoundingMode.HALF_EVEN);
    ...
    public static final MathContext DECIMAL64 =
        new MathContext(16, ut.math.RoundingMode.HALF_EVEN);
    ...
    public static final MathContext DECIMAL128 =
        new MathContext(34, ut.math.RoundingMode.HALF_EVEN);
     ...
     * @serial
     */
    final ut.math.RoundingMode roundingMode;

    /* ----- Constructors ----- */

    /**
     * Constructs a new {@code MathContext} with the specified
     * precision and the {@link ut.math.RoundingMode#HALF_UP HALF_UP} rounding
     * mode.
     *
     ...
     */
    public MathContext(int setPrecision,
                       ut.math.RoundingMode setRoundingMode) {
    ...
    public MathContext(String val) {
        ...
        try { // any error here is a string format problem
            ...
            roundingMode = ut.math.RoundingMode.valueOf(str);
     ...
     * This will be one of
     * {@link  ut.math.RoundingMode#CEILING},
     * {@link  ut.math.RoundingMode#DOWN},
     * {@link  ut.math.RoundingMode#FLOOR},
     * {@link  ut.math.RoundingMode#HALF_DOWN},
     * {@link  ut.math.RoundingMode#HALF_EVEN},
     * {@link  ut.math.RoundingMode#HALF_UP},
     * {@link  ut.math.RoundingMode#UNNECESSARY}, or
     * {@link  ut.math.RoundingMode#UP}.
     *
     * @return a {@code RoundingMode} object which is the value of the
     *         {@code roundingMode} setting
     */

    public ut.math.RoundingMode getRoundingMode() {
        return roundingMode;
    }
