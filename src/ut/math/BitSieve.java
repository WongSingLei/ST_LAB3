...
class BitSieve {
     ...
     * be even.
     */
    BitSieve(ut.math.BigInteger base, int searchLen) {
        /*
        ...
        ut.math.MutableBigInteger b = new ut.math.MutableBigInteger(base);
        ut.math.MutableBigInteger q = new ut.math.MutableBigInteger();
        do {
     ...
     */
    ut.math.BigInteger retrieve(ut.math.BigInteger initValue, int certainty, java.util.Random random) {
        ...
        for (int i=0; i<bits.length; i++) {
            ...
            for (int j=0; j<64; j++) {
                if ((nextLong & 1) == 1) {
                    ut.math.BigInteger candidate = initValue.add(
